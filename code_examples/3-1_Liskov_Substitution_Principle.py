...
# ------------------------------ 01 ------------------------------
# Добавились журналы, газеты. А еще еще что-то захотят добавить...
# Это каждый раз все отчеты нужно переделывать. Работы много.
# Нужно больше программистов в команду...
